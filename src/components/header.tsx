    ...
    return (
        <div className="flex items-center flex-col  mt-40 text-center">
            <div className="space-y-7 relative md:mx-30">
                ...
                <motion.h1 initial={{y : 5, opacity : 0}} viewport={{once : true}} whileInView={{y : 0, opacity : 1, transition: {duration : 0.2, ease : "circOut"}}} className="md:text-7xl text-4xl">Whispers of Peace from Your Favorite 
                ...
                <motion.p 
                    initial={{y : 7, opacity : 0}} viewport={{once : true}} whileInView={{y : 0, opacity : 1, transition: {duration : 0.3, ease : "circOut"}}}
