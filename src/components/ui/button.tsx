    ...
    "flex justify-center items-center  transition-colors ease-linear cursor-pointer  ",
    {
      variants : {
        variant : {
            ...
            secondary : "border border-slate-600 text-slate-50 bg-gradient-to-tr from-slate-700 to-zink-900 text-pink-500 md:rounded-tr-2xl rounded-tr-xl md:rounded-bl-2xl rounded-bl-xl",
            loading : ""
        },
        size : {
