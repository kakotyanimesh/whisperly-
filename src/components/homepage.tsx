...
export default function HomePage(){
    return (
        <div className="flex items-center justify-center md:mx-30 mt-40 text-center">
            <div className="space-y-7 relative ">
                ...
                <div className="flex justify-center items-center mt-20">
                    <AudioCard character="MI-jeong" source="My Liberation Notes" quote="if we had lived in seoul, would we have been different? no matter where i lived... i think i would have been the same. regardless of where i lived, my life would have been just like this." duration="0.28 / 0.32" />
